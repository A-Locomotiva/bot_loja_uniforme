...
export function WhatsAppContact() {
  ...
  function handleSend() {
    const number = '5519999546249'
    const text = message.trim() || 'Olá, gostaria de mais informações!'
    window.open(`https://wa.me/${number}?text=${encodeURIComponent(text)}`, '_blank')
  }

  return (
    <section className="py-16 px-4" style={{ backgroundColor: '#ef8226' }}>
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-white text-sm mt-4 opacity-80">(019) 999546249</p>
      </div>
    </section>
  )
}
